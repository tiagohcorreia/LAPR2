...
import pt.ipp.isep.dei.esoft.project.ui.gui.AnalyseDealsApplication;
import pt.ipp.isep.dei.esoft.project.ui.gui.GuiHandler;
...
public class NetworkManagerUI implements Runnable {
    ...
    @Override
    public void run() {
        //GuiHandler.myLaunch(ListDealsGUI.class);
        ...
        options.add(new MenuItem("Analyse Deals", new AnalyseDealsApplication()));
