...
import java.util.List;
    ...
    public class PurchaseOrderController {
        ...
        public List<Order> getPurchaseOrdersByProperty(Property property) {
            ...
            Collections.sort(purchaseOrders, Comparator.comparing(Order::getOrderAmount).reversed());
...
//        }
        public void acceptPurchaseOrder(String id, String agentEmail) {
            Order purchaseOrder = purchaseOrderRepository.getPurchaseOrderById(id);
        ...
        private void declineOtherPurchaseOrders(String agentEmail) {
            List<Order> ordersForProperty = purchaseOrderRepository.getAll() ;
